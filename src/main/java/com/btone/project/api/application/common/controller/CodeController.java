...
import com.btone.project.api.application.common.service.CodeService;
...
public class CodeController {
	...
	@PostMapping("/{method}")
	public ResponseEntity<?> methods(@PathVariable String method, @RequestBody CodeRequestDTO input) {
