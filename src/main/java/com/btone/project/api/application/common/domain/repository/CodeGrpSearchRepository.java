...
//		return jpaQueryFactory.select(new QCodeGrpResponseDTO(codeGrp.grpCd, codeGrp.grpCdNm, codeGrp.desc1, codeGrp.desc2, codeGrp.delYn, codeGrp.createdDate, codeGrp.modifiedDate))
//				.from(codeGrp)
//				.fetch();
		return null;
	}
